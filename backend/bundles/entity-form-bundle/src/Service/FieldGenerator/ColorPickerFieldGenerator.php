...
#[Priority(1)]
class ColorPickerFieldGenerator implements FieldGeneratorInterface
{
    public function isSupport(?EntityFormFieldAttribute $propertyAttribute, Type $type): bool
    {
        return $type->getBuiltinType() === 'string' && !is_null($propertyAttribute) && $propertyAttribute->component === EntityFormFieldComponentEnum::COLOR_PICKER_FIELD;
    }
    ...
    public function generate(
        ...
        $field->component = EntityFormFieldComponentEnum::COLOR_PICKER_FIELD;
