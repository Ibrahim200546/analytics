...
class TextFieldGenerator implements FieldGeneratorInterface
{
    ...
    public function generate(
        ...
        if (!is_null($entityFormField?->componentArguments)) {
            if (array_key_exists('mask', $entityFormField->componentArguments)) {
                $field->componentArguments['mask'] = $entityFormField->componentArguments['mask'];
            }
        }
