 ...
 */
final class Version20241209075055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE web_resource_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE web_resource (id INT NOT NULL, name VARCHAR(255) NOT NULL, list_articles_link VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE web_resource_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE web_resource');
    }
}
