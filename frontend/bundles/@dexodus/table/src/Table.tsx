...
import Button, {ButtonSizes} from "@dexodus/bootstrap/src/UserInterface/Button";
import {BallTriangle} from "react-loader-spinner";
import useModal from "@dexodus/bootstrap/src/UserInterface/Modal/useModal";
import Settings from "@dexodus/table/src/Settings";
...
const Table =  ({adapter, className, setRefresh, name, setShowSettings, setJselRef = () => {}, max}: TableProps) => {
                ...
                <tr>
                    <td colSpan={columns.length + Math.min(actions.length, 1)}>
                        <div className={styles.tableFooter}>
                            ...
                            />
                            <i>Всего: {adapter.getTotalData()}{max !== undefined ? ` из ${max}` : ''}</i>
                        </div>
                    </td>
                </tr>
                </tfoot>
